...
class BLAZE_DEMO_IMPORTER_Customizer_Importer {
    ...
    public static function import($customizerFile) {
        ...
        if ('array' != gettype($data)) {
            $error = __('Error importing settings! Please check that you uploaded a customizer export file.', 'blazethemes-demo-importer');
            return;
        }
        ...
        if ($data['template'] != $template) {
            $error = __('Error importing settings! The settings you uploaded are not for the current theme.', 'blazethemes-demo-importer');
            return;
        }
